package com.fengying.ad.mysql;

import com.alibaba.fastjson.JSON;
import com.fengying.ad.mysql.constant.OpType;
import com.fengying.ad.mysql.dto.ParseTemplate;
import com.fengying.ad.mysql.dto.TableTemplate;
import com.fengying.ad.mysql.dto.Template;
    ...
    private void loadMeta(){
        for(Map.Entry<String, TableTemplate> entry:template.getTableTemplateMap().entrySet()){
            ...
            jdbcTemplate.query(SQL_SCHEMA,new Object[]{
                    template.getDatabase(),table.getTableName()},(rs,i)->{
